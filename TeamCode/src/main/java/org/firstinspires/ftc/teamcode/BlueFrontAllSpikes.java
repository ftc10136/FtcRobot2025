...
public class BlueFrontAllSpikes extends LinearOpMode {
    ...
    private Command getAutoSequence() {
        ...
        var shot3Pose = paths.Path12.endPose();
                        ...
                        new SequentialCommandGroup(
                                ...
                                new ParallelRaceGroup(
                                        new SequentialCommandGroup(
                                                ...
                                                Robot.drivetrain.followPath(paths.Path7, false, 0.24)
                                        ),
                                        Robot.commandFloorLoad()
                                ),
                                ...
                                //return to shoot position
                                Robot.drivetrain.followPath(paths.Path9, false, 1),
                        ...
                        new SequentialCommandGroup(
                                ...
                                new ParallelRaceGroup(
                                        new SequentialCommandGroup(
                                                ...
                                                Robot.drivetrain.followPath(paths.Path11, false, 0.24)
                                        ),
                                        Robot.commandFloorLoad()
                                ),

                                //return to shoot position
                                Robot.drivetrain.followPath(paths.Path12, false, 1),
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path8 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(17.200, 84.000),
                                    new Pose(26.121, 73.034),
                                    new Pose(15.800, 72.138)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(180))
