//from: https://github.com/wpilibsuite/allwpilib/blob/main/wpilibj/src/main/java/edu/wpi/first/wpilibj/util/Color.java
...
public class Color {
    ...
    private static double roundAndClamp(double value) {
        return Range.clip(Math.ceil(value * (1 << 12)) / (1 << 12), 0.0, 1.0);
    }
